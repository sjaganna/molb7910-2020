...
6. Avoid hard coding file names and instead use relative paths. Use `getwd()` to figure out what your working directory is. `~` represents the current working directory. 
